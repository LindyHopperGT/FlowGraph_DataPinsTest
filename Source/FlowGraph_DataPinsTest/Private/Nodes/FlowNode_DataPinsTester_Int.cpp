...
UFlowNode_DataPinsTester_Int::UFlowNode_DataPinsTester_Int(const FObjectInitializer& ObjectInitializer)
...
FFlowDataPinResult UFlowNode_DataPinsTester_Int::TrySupplyDataPin_Implementation(FName PinName) const
{
